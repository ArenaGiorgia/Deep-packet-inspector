...
void CatturaTraffico::avvia() {
    ...
    //il buffer fornito da pcap dove scriverà il testo di eventuali errori
    ...
    //lanciamo il thread in background dicendogli di eseguire la funzione cattura
...
void CatturaTraffico::cattura() {
    ...
    while (blocco_sicuro()) {
        ...
        if (risultato == 1) { 
            ...
            //creiamo un nuovo pacchetto vuoto
